...
int main(string[] args)
{
	...
	if ( files.length == 0 ) {
		...
		//remove the src and source folders
	...
	//if not on the command line, force a rebuild every time
	if ( indexOf(dubArgs, "--force") == -1 ) dubArgs ~= "--force";
...
string helpText = `
  ...
  4. Run dub --force to build and run ./src/foo.d
