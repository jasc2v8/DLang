...
void main(string[] args) {
	...
	closedFolderImage = new Image(display, "res" ~ dirSeparator ~ "closedFolder.gif");
	openFolderImage = new Image(display, "res" ~ dirSeparator ~ "openFolder.gif");
	targetImage = new Image(display, "res" ~ dirSeparator ~ "target.gif");
